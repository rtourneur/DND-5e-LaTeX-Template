...
\begin{quotebox}
	...
	créature se trouvant à portée subit 1 point de dégât perforant et doit effectuer un jet de sauvegarde de Constitution DD 11, prenant \dice{3d6}
...
\PJs peuvent trouver \dice{1d10} PO et \dice{2d10} PA dans chaque coffre.
...
une potion de \emph{Soins} et \dice{5d10+20} PO. Dans le second coffre, outre les vêtements de forestiers se trouvent \dice{3d6} flèches +1 dans un
carquois et \dice{4d8+10} PO.
...
\begin{quotebox}
	...
	chaque round, devenant étourdie pour \dice{1d4} rounds et prenant \dice{1d6} dégâts de poison en cas d'échec, ou seulement la moitié de ces dégâts en
	cas de réussite. Le gaz se dissipe au bout de \dice{1d3} rounds. Un jet d’Intelligence (Investigation) DD 15 réussi permet au personnage de déduire
